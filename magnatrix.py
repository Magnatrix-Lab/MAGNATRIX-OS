...
class ModuleRegistry:
    ...
    CORE_MODULES = [
        ...
        ("model_serving", "core.model_serving_native", "ModelServingEngine"),
        ("prompt_chaining", "core.prompt_chaining_native", "PromptChain"),
        ("longterm_memory", "core.longterm_memory_native", "LongTermMemory"),
        ("tool_use", "core.tool_use_framework_native", "ToolUseFramework"),
        ("data_lake", "core.data_lake_native", "DataLake"),
        ("etl_pipeline", "core.etl_pipeline_native", "ETLPipeline"),
        ("stream_processing", "core.stream_processing_native", "StreamProcessor"),
        ("data_quality", "core.data_quality_engine_native", "DataQualityEngine"),
        ("secret_rotation", "core.secret_rotation_native", "SecretRotationEngine"),
        ("key_management", "core.key_management_native", "KeyManagement"),
        ("intrusion_detection", "core.intrusion_detection_native", "IntrusionDetectionSystem"),
        ("zerotrust", "core.zerotrust_policy_native", "ZeroTrustPolicy"),
        ("bluegreen", "core.bluegreen_deploy_native", "BlueGreenDeployment"),
        ("canary", "core.canary_release_native", "CanaryRelease"),
        ("chaos", "core.chaos_engineering_native", "ChaosEngineering"),
        ("slo_monitor", "core.slo_monitor_native", "SLIMonitor"),
        ("voice_ui", "core.voice_ui_native", "VoiceUI"),
        ("gesture", "core.gesture_recognition_native", "GestureRecognition"),
        ("edge_inference", "core.edge_inference_native", "EdgeInference"),
        ("gguf_converter", "core.gguf_converter_native", "GGUFConverter"),
        ("mobile_companion", "core.mobile_companion_native", "MobileCompanionAPI"),
        ("backup_v2", "core.backup_engine_v2_native", "BackupEngineV2"),
        ("compression", "core.compression_engine_native", "CompressionEngine"),
        ("encryption_v2", "core.encryption_engine_v2_native", "EncryptionEngineV2"),
        ("replication", "core.replication_engine_native", "ReplicationEngine"),
        ("snapshot", "core.snapshot_engine_native", "SnapshotEngine"),
        ("log_analysis", "core.log_analysis_native", "LogAnalysisEngine"),
    ]
